...
public class HotelTest {
    ...
    public void setUp() {
        ...
        // The initialization of a password-variable
        correctPassword = Password.INITIAL;
        wrongPassword = Password.INITIAL + "_invalid";
    }

    /**
     * checkIn must return null if the password is wrong.
     */
    @Test
    ...
    /**
     * ToString is difficult to test fully because there is no restriction on the format
